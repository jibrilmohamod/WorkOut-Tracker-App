<template>
 <div class="max-w-screen-sm mx-auto px-4 py-10">
  <!--Error Handling-->
  <div v-if="errorMsg" class="mb10 p-4 rounded-md bg-light-grey">
  ...
  <!--Registration-->
  <form class="p-8 flex-col bg-light-grey rounded-md shadow-lg">
   ...
   <router-link class="text-sm ml-6 text-center " :to="{ name: 'login' }">
    Already have an account ?
    <span class="text-at-light-green">Log In</span></router-link
   >
  </form>
 </div>
</template>
